...
class Popover {
	constructor(trigger, { position = 'top', className = 'popover' }) {
		...
		let title = this.popover.querySelector('#ambossSnippetTitle')
		title.textContent = this.trigger.getAttribute('data-title')

		let etymology = this.popover.querySelector('#ambossSnippetEtymology')
		etymology.textContent = this.trigger.getAttribute('data-etymology')

		let description = this.popover.querySelector('#ambossSnippetDescription')
		description.textContent = this.trigger.getAttribute('data-description')

		let link = this.popover.querySelector('#ambossLink')
		link.setAttribute('src', this.trigger.getAttribute('data-link'))
		link.textContent = this.trigger.getAttribute('data-label')
